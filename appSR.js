...
// Database Paths
const dbPathTemp  = 'Room2/temp';
const dbPathHum  = 'Room2/hum';
const dbPathFan  = 'Room2/fan';
const dbPathLight  = 'Room2/light';
const dbPathFanbtn  = 'Room2/fanbtn';
const dbPathLightbtn  = 'Room2/lightbtn';
...
const dbPathTempinput  = 'Room2/tempinput';
